...
from create_demos_ori import collect_and_save_demos
...
demo_params = {
    ...
    'tgt_bounding_angles': np.array([180, 0, 90, 180, 0, 270]) * np.pi/180,
    'max_steps': 500,
...
# From experience, there are some random crashes in Coppelia/pyrep
# So creating demos 1 color at a time is better.
colors = (
    #(255, 0, 0),
    #(0, 255, 0),
    (0, 0, 255),
...
for color256 in colors:
    demo_params['save_location'] = DIR_PATH + 'data/demo_camera_32_reach_ori_cuboid_' + rgb256_to_hex(color256)
    env = PyRep()
